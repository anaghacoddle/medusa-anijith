...
export function useTableConfiguration({
  ...
  }, [currentActiveView, apiColumns, originalHandleViewChange, queryPrefix, setSearchParams]);
  ...
  }, [currentActiveView, apiColumns, queryPrefix, originalHandleViewChange, setSearchParams]);
