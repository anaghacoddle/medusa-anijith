...
import { Select, Button, Tooltip, DropdownMenu, Badge, usePrompt, toast } from "@medusajs/ui";
import {
  Eye,
  EyeSlash,
  Plus,
...
export const ViewSelector: React.FC<ViewSelectorProps> = ({
  ...
  }, [deletingViewId, deleteView, currentActiveView?.id, onViewChange]);
      ...
      <div className="flex items-center gap-2">
        <DropdownMenu>
          ...
          <DropdownMenu.Content className="w-[260px]">
            ...
            <DropdownMenu.Item onClick={handleSaveView} className="text-ui-fg-interactive">
