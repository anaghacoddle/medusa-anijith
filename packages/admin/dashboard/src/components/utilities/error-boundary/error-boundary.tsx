...
export const ErrorBoundary = (props: { code?: number }) => {
  ...
  } else if ((error as any).isPermissionError) {
    // Handle our custom permission error
    code = (error as any).status ?? 403;
  }
  props.code ? (code = props.code) : (code = code);
  /**
