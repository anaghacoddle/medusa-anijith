...
export const ProductCreateOrganizationSection = ({
  ...
  return (
    <div id="organize" className="flex flex-col gap-y-8">
      ...
      {/* <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
        <div>
          <Form.Label optional>{t("products.fields.shipping_profile.label")}</Form.Label>
          <Form.Hint>
        ...
        <Form.Field
          control={form.control}
          name="product.shipping_profile_id"
          render={({ field }) => {
            return (
              <Form.Item>
                <Form.Control>
            ...
            return (
              <Form.Item>
                <div className="flex items-start justify-between gap-x-4">
                  <div>
                    <Form.Label optional>{t("products.fields.sales_channels.label")}</Form.Label>
                    <Form.Hint>
