...
export const ProductVariantMedia = () => {
  ...
  const { variant, isFetching, isError, error } = useProductVariant(id!, variant_id!, {
  ...
  return (
    <RouteFocusModal>
      {ready && <EditProductVariantMediaForm variant={variant as ProductMediaVariantsReponse} />}
    </RouteFocusModal>
  );
};
