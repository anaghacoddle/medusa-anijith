      ...
      >
        <KeyboundForm onSubmit={handleSubmit} className="flex h-full flex-col">
            ...
            <div className="flex w-full items-center justify-between gap-x-4">
              <div className="-my-2 w-full max-w-[600px] border-l">
                <ProgressTabs.List className="grid w-full grid-cols-3">
                  <ProgressTabs.Trigger status={tabState.product} value={Tab.PRODUCT}>
          ...
          <RouteFocusModal.Body className="size-full overflow-hidden">
            <ProgressTabs.Content className="size-full overflow-y-auto" value={Tab.PRODUCT}>
              <PriceListPricesAddProductIdsForm form={form} priceList={priceList} />
            </ProgressTabs.Content>
            <ProgressTabs.Content className="size-full overflow-hidden" value={Tab.PRICE}>
          ...
          <RouteFocusModal.Footer>
            <div className="flex items-center justify-end gap-x-2">
              ...
              <PrimaryButton tab={tab} next={handleNextTab} isLoading={isPending} />
            </div>
          </RouteFocusModal.Footer>
        </KeyboundForm>
      </ProgressTabs>
