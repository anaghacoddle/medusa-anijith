...
import { OrderInvoiceSection } from "./components/order-invoice-section";
import { OrderPaymentSection } from "./components/order-payment-section";
import { OrderPreorderSection } from "./components/order-preorder-section";
import { OrderSummarySection } from "./components/order-summary-section";
import { DEFAULT_FIELDS } from "./constants";
import { orderLoader } from "./loader";
import PickupDateWidget from "./components/pickup-date-widget/pickup-date-widget";
  ...
  return (
    ...
    >
      ...
      <TwoColumnPage.Sidebar>
        ...
        <OrderPreorderSection order={order} />
        <PickupDateWidget data={order} />
      </TwoColumnPage.Sidebar>
    </TwoColumnPage>
  );
};
