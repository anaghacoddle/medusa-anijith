...
export const OrderEditCreateForm = ({ order, preview }: ReturnCreateFormProps) => {
  ...
  const { mutateAsync: cancelOrderEditRequest, isPending: isCanceling } = useCancelOrderEdit(
    order.id
  );
        ...
        <RouteFocusModal.Body className="flex size-full justify-center overflow-y-auto">
          <div className="mt-16 w-[720px] max-w-[100%] px-4 md:p-0">
            ...
            <div className="mt-8 border-y border-dotted py-4">
              ...
              <div className="mb-2 flex items-center justify-between">
                <span className="txt-small text-ui-fg-subtle">{t("orders.edits.newTotal")}</span>
                  ...
                  <Form.Item>
                    <div className="mt-8 flex">
                      <div className="block flex-1">
                        ...
                        <Form.Hint className="!mt-1">{t("orders.edits.noteHint")}</Form.Hint>
                      </div>
