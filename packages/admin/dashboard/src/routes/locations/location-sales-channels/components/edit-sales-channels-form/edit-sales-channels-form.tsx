...
export const LocationEditSalesChannelsForm = ({ location }: EditSalesChannelsFormProps) => {
      ...
      <KeyboundForm onSubmit={handleSubmit} className="flex h-full flex-col">
        <RouteFocusModal.Header>
          <RouteFocusModal.Title asChild>
            <VisuallyHidden>{t("stockLocations.salesChannels.header")}</VisuallyHidden>
          </RouteFocusModal.Title>
          <RouteFocusModal.Description asChild>
            <VisuallyHidden>{t("stockLocations.salesChannels.hint")}</VisuallyHidden>
